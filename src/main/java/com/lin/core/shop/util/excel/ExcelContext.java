...
public class ExcelContext {
     ...
     * @throws Exception
     */
    public ExcelExportResult createMultiSheetExcel(Map<String, List> map) throws Exception {
        return createMultiExcelForPart(map, null, null);
    }
    ...
    public ExcelExportResult createMultiExcelForPart(Map<String, List> map, ExcelHeader header, List<String> fields) throws Exception {
        return excelExport.createMultiExcel(map, header, fields);
    }
